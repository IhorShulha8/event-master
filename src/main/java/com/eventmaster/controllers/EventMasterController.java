...
import com.eventmaster.models.requests.*;
import com.eventmaster.models.responses.*;
...
public class EventMasterController {
    ...
    public ResponseEntity<TaskWithLayoutResponse> getEventTask(@Validated @PathVariable("eventName") String eventName,
